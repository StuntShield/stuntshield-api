...
class StuntingController:
    ...
    def predict_stunting():
        if request.method == "POST":
            ...
            if year is not None and month is not None and day is not None and jenis_kelamin is not None and tinggi_badan is not None and berat_badan is not None:
                ...
                if umur <= 24 :
                    ...
                    prediction_ideal_result = StuntingController.model_ideal_024.predict(input_data_ideal_024_predict)
                    data_ideal ={
                        "Jenis Kelamin" : jenis_kelamin,
                        "Tinggi Badan (cm)" : tinggi_badan,
